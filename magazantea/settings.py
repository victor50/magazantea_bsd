...
EMAIL_PORT = 587
EMAIL_HOST_USER = 'magazzinodb@gmail.com'
EMAIL_HOST_PASSWORD = 'Feder1c0'
...
MEDIA_ROOT = '/usr/local/www/magazantea/media/'
...
STATIC_ROOT = '/usr/local/www/magazantea/static'
...
TEMPLATES = [
    {
        ...
        'DIRS': ['/usr/local/www/magazantea/templates',
],
        'APP_DIRS': True,
        'OPTIONS': {
            'context_processors': [
...
CACHES = {
    'default': {
	    'BACKEND': 'django.core.cache.backends.memcached.MemcachedCache',
            ...
            'TIMEOUT' : 3600  },  # Durata cache 1 ora
